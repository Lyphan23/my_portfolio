...
const Projects = ({ darkMode }) => {
  ...
  return (
    <section
      id="projects"
      style={{ backgroundColor: darkMode ? "#0D182E" : "#F3F8FD" }}
      ...
      <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="p-4 flex flex-col flex-grow">
                ...
                <p
                  ...
                  style={{ color: darkMode ? "#d1d5db" : "#6d7280" }}
                >
                  {project.desc}
                </p>
        ...
        <div className="text-center mt-10">
          <a
            ...
            text-sm rounded-full hover:shadow-lg hover:shadow-orange-500/25 transition-all"
            data-aos="zoom-in"
            data-aos-delay="400"
          >
            <FaGithub />
