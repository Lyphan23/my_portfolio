            ...
            <div className="w-full pt-4 sm:pt-6">
              ...
              >
                <a href={CV} download className="w-full sm:w-auto">
                  <button
                    className="w-full sm:w-auto flex items-center justify-center text-white bg-orange-500 bg-gradient-to-r from-orange-500 to-amber-500 border-0 py-3 px-8 hover:shadow-[0_0_40px_rgba(255,165,0,0.7)] rounded-full text-base sm:text-lg
                   font-semibold transition-all duration-300 transform active:scale-95 shadow-lg"
                  >
